import{r,j as t}from"./index-dd44u1t_.js";import{s as h}from"./SupaBase-ke3yp_R2.js";import{N as u}from"./NavBar-DcPLVanW.js";/* empty css               */import"./createSvgIcon-oaL59T5h.js";import"./react-toastify.esm-BqH9nIDh.js";const E=()=>{const[i,d]=r.useState([]),[l,o]=r.useState(!0),[s,a]=r.useState(null),p=async()=>{try{o(!0),a(null);const e=localStorage.getItem("patientData");if(!e)throw new Error("Patient information is not found. Please log in.");const n=JSON.parse(e);if(!n.id)throw new Error("Invalid patient data. Missing patient ID.");const{data:m,error:c}=await h.from("Appointments").select(`
          id,
          patient_id,
          patient_name,
          doctor_id,
