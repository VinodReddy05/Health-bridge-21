import{r,j as t}from"./index-DzgEqHQw.js";import{s as h}from"./SupaBase-B0w5X8Hx.js";import{N as u}from"./NavBar-DrtCkTpn.js";/* empty css               */import"./createSvgIcon-DmtkkOPc.js";import"./react-toastify.esm-C_3G8D9r.js";const E=()=>{const[i,d]=r.useState([]),[l,o]=r.useState(!0),[s,a]=r.useState(null),p=async()=>{try{o(!0),a(null);const e=localStorage.getItem("patientData");if(!e)throw new Error("Patient information is not found. Please log in.");const n=JSON.parse(e);if(!n.id)throw new Error("Invalid patient data. Missing patient ID.");const{data:m,error:c}=await h.from("Appointments").select(`
          id,
          patient_id,
          patient_name,
          doctor_id,
